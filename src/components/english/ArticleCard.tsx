...
export default function ArticleCard({
  ...
  if (variant === "trending") {
    return (
      <Link
        to={href}
        className="group flex w-[78vw] shrink-0 snap-start flex-col gap-1 sm:w-[260px] md:w-auto md:min-w-0"
      >
        {typeof index === "number" && (
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {article.excerpt && (
          <p className="text-xs text-[#6B756E] leading-relaxed line-clamp-2 mb-3">
            {article.excerpt}
          </p>
        )}
