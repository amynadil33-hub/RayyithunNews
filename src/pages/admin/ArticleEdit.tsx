            ...
            <div>
              ...
              <Editor
                ...
                init={{
                  ...
                  content_style:
                    portalSlug === "dhivehi"
                      ? `@font-face { font-family: "MV AammuFK"; src: url("/fonts/MV_AammuFK_Regular.ttf") format("truetype"); font-weight: 100 900; font-style: normal; font-display: swap; } @font-face { font-family: "MV MAG Round XBold"; src: url("/fonts/Mv_MAG_Round_XBold.otf") format("opentype"); font-weight: 800; font-style: normal; font-display: swap; } body { font-family: "MV MAG Round XBold", "MV Faseyha", "MV Waheed", "MV Amaan XP", "Faruma", "Noto Sans Thaana", sans-serif; direction: rtl; text-align: right; line-height: 1.9; font-size: 20px; padding: 12px; } h1, h2, h3, h4, h5, h6 { font-family: "MV AammuFK", "MV MAG Round XBold", sans-serif; } p { margin: 0 0 1.25rem; } blockquote { border-right: 4px solid #103820; background: #D8E8D8; margin: 1.5rem 0; padding: 1rem 1.25rem; } img { max-width: 100%; height: auto; }`
