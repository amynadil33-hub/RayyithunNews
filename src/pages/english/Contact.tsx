  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8]">
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with the RAYYITHUN editorial team."
        />
      </Helmet>
      <EnglishHeader />
      ...
      <div className="max-w-5xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div>
              <h2 className="font-serif text-lg font-semibold text-[#142820] mb-4">
                Get in Touch
              </h2>
              <p className="text-sm text-[#6B756E] leading-relaxed">
                Have a news tip, correction, or feedback? We'd love to hear from
                you. Our editorial team typically responds within 24 hours.
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <MailIcon
                  size={16}
                  className="text-[#103820] mt-0.5 flex-shrink-0"
                />
                <div>
                  <p className="text-xs text-[#6B756E]">Email</p>
                  <a
                    href={`mailto:${CONTACT_EMAIL}`}
                    className="text-sm text-[#142820] hover:text-[#103820]"
                  >
                    {CONTACT_EMAIL}
                  </a>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#142820]">
          ...
          <div className="md:col-span-3 bg-white border border-[#E5E7E2] rounded-sm p-6">
            {sent ? (
              <div className="text-center py-10">
                ...
                <h3 className="font-serif text-lg font-semibold text-[#142820] mb-2">
                  Message Sent
                </h3>
