...
export default function DhivehiAdvertise() {
  ...
  const inputClass =
    "w-full border border-[#E5E7E2] rounded-sm px-3 py-2.5 text-sm bg-[#F8F8F8] focus:outline-none focus:border-[#103820]";
  const labelClass =
    "block text-xs font-medium text-[#142820] mb-1 text-right font-thaana";
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="advertiser-name" className={labelClass}>
                    ނަން *
                  </label>
                  <input
                    id="advertiser-name"
                    ...
                    className={`${inputClass} text-right font-thaana`}
                  />
                </div>
                <div>
                ...
                <div>
                  <label htmlFor="advertiser-phone" className={labelClass}>
                    ފޯން
                  </label>
                  <input
                    id="advertiser-phone"
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`${inputClass} resize-none text-right font-thaana thaana-body`}
                />
              </div>
              <button
                type="submit"
