...
export default function DhivehiSubmitArticle() {
  ...
  const inputClass =
    "w-full border border-[#D8DED9] rounded-sm px-3 py-2.5 text-sm bg-[#F8F8F8] focus:outline-none focus:border-[#103820] font-thaana";
  const labelClass =
    "block text-sm font-semibold text-[#142820] mb-1.5 text-right font-thaana";
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8]" dir="rtl" lang="dv">
      <Helmet>
        ...
        <meta
          name="description"
          content="ރައްޔިތުންގައި ޝާއިޢުކުރުމަށް އާރޓިކަލް ހުށަހަޅާ."
        />
      </Helmet>
      <DhivehiHeader />
          ...
          {sent ? (
            <div className="text-center py-10">
              ...
              <p className="font-thaana text-[#6B756E]">
                ތިޔަ ހުށަހެޅި އާރޓިކަލް ރައްޔިތުންގެ އެޑިޓޯރިއަލް ޓީމަށް
                ލިބިއްޖެ.
              </p>
              <button
                type="button"
                onClick={() => setSent(false)}
                className="mt-6 border border-[#103820] px-5 py-2 text-sm font-thaana text-[#103820] hover:bg-[#103820] hover:text-white"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="submission-name" className={labelClass}>
                    ނަން
                  </label>
                  <input
                    id="submission-name"
                ...
                <div>
                  <label htmlFor="submission-address" className={labelClass}>
                    އެޑްރެސް
                  </label>
                  <input
                ...
                <div>
                  <label htmlFor="submission-phone" className={labelClass}>
                    ފޯން
                  </label>
                  <input
                    id="submission-phone"
              ...
              <div>
                <label htmlFor="submission-content" className={labelClass}>
                  ލިޔުއްވާ
                </label>
                <textarea
                  ...
                  className={`${inputClass} resize-y text-right thaana-body leading-loose`}
                />
              </div>

              <div>
                <label htmlFor="submission-photo" className={labelClass}>
                  ފޮޓޯ އަޕްލޯޑް
                </label>
                <label
                  htmlFor="submission-photo"
                  className="flex cursor-pointer items-center justify-center gap-3 border border-dashed border-[#AEB8B1] bg-[#F8F8F8] px-4 py-6 text-sm text-[#526159] transition-colors hover:border-[#103820] hover:text-[#103820] font-thaana"
                >
                ...
                />
                <p className="mt-1 text-xs text-[#6B756E] font-thaana">
                  10MB އަށްވުރެ ކުޑަ ފޮޓޯއެއް
                </p>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#103820] text-white py-3 rounded-sm text-sm font-bold hover:bg-[#183028] transition-colors disabled:opacity-60 font-thaana"
              >
