...
-- ============================================================
INSERT INTO public.categories (portal_id, name, slug, description, sort_order) VALUES
  ('00000000-0000-0000-0000-000000000001', 'ހަބަރު', 'news', 'ދިވެހިރާއްޖޭގެ އެންމެ ފަހުގެ ހަބަރު', 1),
  ('00000000-0000-0000-0000-000000000001', 'ދުނިޔެ', 'world', 'ބައިނަލްއަޤްވާމީ ހަބަރު', 2),
  ('00000000-0000-0000-0000-000000000001', 'ވިޔަފާރި', 'business', 'ވިޔަފާރި އަދި އިޤްތިސާދު', 3),
  ('00000000-0000-0000-0000-000000000001', 'ފަތުރުވެރިކަން', 'travel-tourism', 'ފަތުރުވެރިކަމާއި ޓޫރިޒަމް ދާއިރާގެ ހަބަރު', 4),
  ('00000000-0000-0000-0000-000000000001', 'ތައުލީމު', 'education', 'ތަޢުލީމީ ހަބަރާއި މަޢުލޫމާތު', 5),
  ('00000000-0000-0000-0000-000000000001', 'ބާޒާރު', 'market', 'ތިޔަ ބާޒާރުގެ ހަލަތު', 6),
  ('00000000-0000-0000-0000-000000000001', 'ރައްޔިތުން', 'citizen', 'ރައްޔިތުންގެ ވާހަކަ', 7),
  ('00000000-0000-0000-0000-000000000001', 'ތެދުމަގު', 'religion', 'ދީނީ ކަންތައްތައް', 8),
  ('00000000-0000-0000-0000-000000000001', 'ލުއިހަބަރު', 'quick-news', 'ލުއި ހަބަރު', 9),
  ('00000000-0000-0000-0000-000000000001', 'ޕޮޑްކާސްޓް', 'podcast', 'އަޑުގެ ލިޔުންތައް', 10)
ON CONFLICT DO NOTHING;
