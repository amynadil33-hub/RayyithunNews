...
INSERT INTO public.categories (portal_id, name, slug, description, sort_order) VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', 'ތަޢުލީމް', 'education', 'ތަޢުލީމީ ހަބަރާއި މަޢުލޫމާތު', 2),
  ('00000000-0000-0000-0000-000000000001', 'ވިޔަފާރި', 'business', 'ވިޔަފާރި އަދި އިޤްތިސާދު', 3),
  ('00000000-0000-0000-0000-000000000001', 'ތެދުމަގު', 'religion', 'ދީނީ ކަންތައްތައް', 4),
